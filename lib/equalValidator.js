...
{SwiftValidator.call(this, paramName);
    ...
    //
    this._messageTemplates[EqualValidator.ERROR_CODES.NOT_VALID] = 'Значение параметра "' +
...
EqualValidator.prototype.validate = function validate (value)
{
    ...
    {
        this._message = this.getMessageTemplate(EqualValidator.ERROR_CODES.NOT_VALID)
            .replace(
