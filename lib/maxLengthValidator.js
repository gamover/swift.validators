...
{SwiftValidator.call(this, paramName);
    ...
    //
    this._messageTemplates[MaxLengthValidator.ERROR_CODES.NOT_VALID] = 'Максимальная длина значения параметра "' +
...
MaxLengthValidator.prototype.validate = function validate (value)
{
    ...
    if (!valid)
    {
        this._message = this.getMessageTemplate(MaxLengthValidator.ERROR_CODES.NOT_VALID)
            .replace(
