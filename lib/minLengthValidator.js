...
{SwiftValidator.call(this, paramName);
    ...
    //
    this._messageTemplates[MinLengthValidator.ERROR_CODES.SMALL_LENGTH] = 'Минимальная длина значения параметра "' +
...
MinLengthValidator.prototype.validate = function validate (value)
{
    ...
    if (!valid)
    {
        this._message = this.getMessageTemplate(MinLengthValidator.ERROR_CODES.SMALL_LENGTH)
            .replace(
